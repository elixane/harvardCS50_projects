...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        """
        # Convert state to tuple since lists are unhashable for dict keys
        tuple_state = tuple(state) 

        # Return 0 if (state, action) pair is not found 
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        self.q[state, action] = old_q + self.alpha * (new_value_est - old_q)
    ...
    def best_future_reward(self, state):
        ...
        for action in available_actions:
            ...
            # Update best_q_value if this Q-value is higher
    ...
    def choose_action(self, state, epsilon=True):
        ...
        for action in available_actions:
            ...
            # If this Q-value is the highest, update best_q_value and reset best_actions
            if q_value > best_q_value:
                best_q_value = q_value
                best_actions = [action]
            # If this Q-value is equal to the current best, add it to best_actions
            elif q_value == best_q_value:
                best_actions.append(action)
        
        # Return one of the actions with the highest Q-value (if multiple, choose randomly)
